...
-- 开放中的职位 (15个)
INSERT INTO job_postings (enterprise_user_id, enterprise_name, title, description, required_major, min_experience, max_experience, min_salary, max_salary, location, status) VALUES
    (12, '腾讯科技有限公司', '高级Java开发工程师', '负责核心业务系统开发，参与架构设计', '计算机科学与技术', 3, 8, 25000, 40000, '深圳', 'OPEN'),
    (12, '腾讯科技有限公司', '前端开发工程师', '负责Web前端开发，优化用户体验', '软件工程', 2, 5, 20000, 35000, '深圳', 'OPEN'),
    (12, '腾讯科技有限公司', '产品经理', '负责产品规划和需求分析', '不限', 3, 7, 22000, 38000, '深圳', 'OPEN'),
    (13, '阿里巴巴集团', '算法工程师', '负责推荐算法研发和优化', '计算机科学', 2, 6, 30000, 50000, '杭州', 'OPEN'),
    (13, '阿里巴巴集团', '数据分析师', '负责业务数据分析和可视化', '统计学', 1, 4, 18000, 30000, '杭州', 'OPEN'),
    (13, '阿里巴巴集团', '运维工程师', '负责服务器运维和监控', '网络工程', 2, 5, 20000, 32000, '杭州', 'OPEN'),
    (14, '华为技术有限公司', '5G通信工程师', '负责5G技术研发', '通信工程', 3, 8, 28000, 45000, '深圳', 'OPEN'),
    (14, '华为技术有限公司', '嵌入式开发工程师', '负责嵌入式系统开发', '电子信息工程', 2, 6, 25000, 40000, '深圳', 'OPEN'),
    (15, '字节跳动', 'AI研究员', '负责人工智能算法研究', '人工智能', 3, 10, 35000, 60000, '北京', 'OPEN'),
    (15, '字节跳动', '后端开发工程师', '负责后端服务开发', '计算机科学', 2, 5, 22000, 38000, '北京', 'OPEN'),
    (15, '字节跳动', 'UI设计师', '负责产品界面设计', '设计类', 1, 4, 18000, 30000, '北京', 'OPEN'),
    (16, '美团点评', 'Android开发工程师', '负责移动端应用开发', '软件工程', 2, 5, 20000, 35000, '北京', 'OPEN'),
    (16, '美团点评', 'iOS开发工程师', '负责iOS应用开发', '软件工程', 2, 5, 20000, 35000, '北京', 'OPEN'),
    (16, '美团点评', '测试工程师', '负责软件质量保证', '计算机科学', 1, 4, 15000, 25000, '北京', 'OPEN'),
    (16, '美团点评', 'DevOps工程师', '负责CI/CD流程建设', '计算机科学', 2, 6, 22000, 38000, '北京', 'OPEN');
